...
export async function crearResena(resenaData, session = null) {
  try {
    // Usar cliente autenticado si hay sesión
    const client = session ? await createClerkSupabaseClient(session) : supabase
