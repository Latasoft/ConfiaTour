...
export async function crearReserva(reservaData) {
  console.warn('⚠️ DEPRECATED: crearReserva() - Usar ReservasAPI.crear() en su lugar')
...
export async function getReservasByUsuario(userId) {
  console.warn('⚠️ DEPRECATED: getReservasByUsuario() - Usar ReservasAPI.obtenerMias() en su lugar')
...
export async function cancelarReserva(reservaId, userId) {
  console.warn('⚠️ DEPRECATED: cancelarReserva() - Usar ReservasAPI.cancelar() en su lugar')
